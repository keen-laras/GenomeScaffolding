...
/opt/software/mambaforge/envs/yahs/bin/yahs --no-contig-ec --no-scaffold-ec ${REFERENCE_GENOME} bowtie_results/bwt2/{hiC_output}.bwt2pairs.bam 
...
/opt/software/mambaforge/envs/yahs/bin/juicer pre -a -o out_1154_scaff yahs.out.bin yahs.out_scaffolds_final.agp ${REFERENCE_GENOME}.fai > ${OUTPUT_PREFIX}.log 2>&1
